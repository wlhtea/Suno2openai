...
def register(i, j):
    ...
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div[2]/div[2]/div/form/div[3]/div/div/input').send_keys(
        j)
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div[2]/div[2]/div/form/div[5]/div/div/div/div/button').click()
    save_information = driver.find_element(By.XPATH,
                                           '/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div[2]/div[2]/div/form/div[3]/div[2]/div/div[1]/button')
    if save_information:
    ...
    if cookie_string is not None:
        logging.info(f'"""{cookie_string}""",')
    else:
        logging.info('false to get cookie')
